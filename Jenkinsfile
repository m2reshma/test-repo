pipeline {
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/m2reshma/test-repo.git'
            }
        }
        ...
        stage('Checkout K8s YAML Repo') {
            steps {
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/m2reshma/test-k8s.git'
            }
        }
        ...
        stage('Update helm values.yaml with New Docker Image') {
            ...
            steps {
                withCredentials([string(credentialsId: 'github-token', variable: 'GITHUB_TOKEN')]) {
                    ...
                    git config user.email "reshma8466004811@gmail.com"
